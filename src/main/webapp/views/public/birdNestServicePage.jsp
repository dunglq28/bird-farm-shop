<%-- 
    Document   : birdNestServicePage
    Created on : Oct 8, 2023, 12:07:32 AM
    Author     : tt
--%>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="quotes text-center">
                <h3>OUR MISSION</h3>
                <p>" Each of our happy and healthy birds has embryos selected to be born and cared for extremely
                    carefully,
