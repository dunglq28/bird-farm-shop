...
<html>
    ...
    <body>
        ...
        <c:set var="cart" value="${sessionScope.BIRDCART}" />
                                        ...
                                        <div class="col-lg-8">
                                            <div class="p-5">
                                                <div class="d-flex justify-content-between align-items-center mb-5">
                                                    ...
                                                    <h6 class="mb-0 text-muted">0 product</h6>
                                                </div>
                                                    ...
                                                    <div class="row mb-4 d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-4 col-lg-4 col-xl-4">
                                                            ...
                                                            <div class="delete-product">
                                                                <form action="remove-bird">
                                                                    <input type="hidden" name="BirdID" value="${key}" >
<!--                                                                <a href="remove-bird" class="delete-icon text-decoration-none ">
                                                        ...
                                                        <div
                                                            ...
                                                            <h6 class="mb-0">${items.get(key).priceFormat}</h6>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4 d-flex justify-content-between align-items-center">
